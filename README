...
| Attribute | Details |
|-----------|---------|
| Records | 720 (12 months × 20 reps × 3 products) |
| Total Primary Sales Volume | 645K units |
| Time Period | Apr 2024 – Mar 2025 (1 fiscal year) |
| Territories | East, West, North, South |
| Products | Deccan Lite, Spasmofirst, Wokderm Plus |
| Sales Reps | 20 field representatives |
...
- ⚠️ **East territory** — lowest FY conversion ratio at 0.87 vs. portfolio average 0.95; dipped below the 0.80 risk threshold in Q1, indicating rising inventory pressure
- 🌟 **Ravi Menon (South)** — highest target achievement (124%) across all 20 reps = confirmed star performer
- 🔴 **Manoj Roy (East)** — lowest target achievement (69%) across all 20 reps, paired with below-average conversion (0.88) — PIP candidate
- 📦 **Wokderm Plus** — Q4 primary push visible without proportionate secondary offtake at product level; localized channel inventory risk rather than systemic stuffing
...
2. **Manoj Roy** — Place on structured PIP with 90-day target-achievement and doctor-visit milestones
3. **Ravi Menon model** — Document his engagement approach (highest target achievement across all 20 reps) and replicate structured practices across underperforming reps
...
[LinkedIn](https://www.linkedin.com/feed/?trk=sem-ga_campid.14650114788_asid.151761418307_crid.657403558715_kw.linkedin%20profile_d.c_tid.kwd-10521864172_n.g_mt.e_geo.1007828) · [GitHub](https://github.com/prince2310-97)
